...
import 'package:skindisease/views/login/Screens/Signup/components/background.dart';
import 'package:skindisease/views/login/components/already_have_an_account_acheck.dart';
    ...
    if (!_formKey.currentState.validate()) {
      ...
      if (await NetworkCheck().checkInternetConnection()) {
        ...
        try {
          pr.show();
          await Requests.post(
                  "http://skindatabase-001-site1.gtempurl.com/serversidecalls/api/createappuser.php",
                  timeoutSeconds: 120,
                  body: data,
            ...
            if (int.parse(c.content()) == -1) {
              ...
              await Requests.post(
                      "http://skindatabase-001-site1.gtempurl.com/serversidecalls/api/verifylogin.php",
                      timeoutSeconds: 120,
                      body: data,
                      bodyEncoding: RequestBodyEncoding.FormURLEncoded)
                  .then((v) async {
                ...
                if (v.json() != null) {
                  ...
                  if (int.parse(datauser["userID"]) > 0) {
                    var uuid = Uuid();
